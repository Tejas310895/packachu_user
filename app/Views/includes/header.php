...
<head>
    ...
    <script src="public/assets/bootstrap/dist/js/jquery-3.7.1.min.js"></script>
...
<body>
    <ul class="nav justify-content-center fixed-bottom bg-white shadow-lg">
        <li class="nav-item text-center" style="width:33%;">
            <a class="nav-link text-cyan active" href="<?= base_url() ?>">
                <i class="fa-solid fa-house fa-2xl"></i>
            </a>
        </li>
        <li class="nav-item text-center" style="width:33%;">
            <a class="nav-link text-cyan" href="products">
                <i class="fa-solid fa-boxes-stacked fa-2xl"></i>
            </a>
        </li>
        <li class="nav-item text-center" style="width:33%;">
            <a class="nav-link text-cyan" href="profile">
